...
%>
	...
	<img alt="" src="/asmpd10670/images/<%=video.getPoster()%>" width="1500px" height="700px" style="border-radius: 15px;">
 ...
 <div class="row" style="padding-left: 20px;">
	...
	<div class="col-sm-12 d-flex" style="height: 160px;">
		<a href="/asmpd10670/Video/nguoidung/view?id=<%=videoList.getId()%>">
