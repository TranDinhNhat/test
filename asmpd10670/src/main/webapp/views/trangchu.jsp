	...
	<%VideoDao dao = new VideoDao();
		...
		<div class="col-md-4 p-3">
			...
			<div class="video-car" style=" width: 300px; height:300px; border-radius: 15px;">
				...
				<a href="/asmpd10670/Video/home/view?id=<%=video.getId() %>">
				<img alt="" src="/asmpd10670/images/<%=video.getPoster()%>" style="width: 300px; height:180px;border-radius: 10px;">  </a>
				</div>
				<div class="d-flex" style="display: flex;">
				<div>
				<h6 style="padding-right: 60px"><%=video.getTitle() %></h6>
				 </div>
				<div>
