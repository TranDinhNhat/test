...
<div class="content">
	<table class="table table-bordered">
		...
		List<Video> resultList = dao.searchByKeyWord(query);
		...
		<tbody>
			<tr>
				...
				<td> <img alt="" src="/asmpd10670/images/<%=video.getPoster() %>" style="width: 200px;"> </td>
		...
		<a href="/asmpd10670/Video/admin" class=" nav-link text-light bg-primary p-2	"
		style="border:12px soli; border-radius:10px; width: 80px;">Quay Lại</a>
		<%
		}
		}%>
	</table>
