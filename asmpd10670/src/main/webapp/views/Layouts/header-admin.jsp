...
<div style="padding-top: 45px;">
 <div class="flex-shrink-0 p-3 bg-white " style="width: 280px; position: fixed; ">
    <ul class="list-unstyled ps-0">
      <li class="mb-1">
        ...
        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
            <li><a class="nav-link text-dark active" aria-current="page" href="/asmpd10670/index/admin">
                                Trang chủ
                          </a></li>
            <li><a class="nav-link text-dark active" aria-current="page" href="/asmpd10670/Favorite/admin">
            	 </i>VideoLike</a></li>
            <li><a class="nav-link text-dark active" aria-current="page" href="/asmpd10670/Share/admin">
            	 </i>Quản Lý Share</a></li>
          </ul>
      </li>
      <li class="mb-1">
        <button class="btn btn-toggle align-items-center rounded collapsed" >
        ...
        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
            <li><a class="nav-link text-dark" href="/asmpd10670/Video/admin">
                               </i> Video
                          </a></li>
            <li><a class="nav-link text-dark" href="/asmpd10670/User">
                               </i> Users
                          </a></li>
          </ul>
      </li> 
      ...
      <li class="mb-1">
        ...
        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
            <li><a href="/asmpd10670/Video/admin/create" class="nav-link text-dark">New...</a></li>
            <li><a href="/asmpd10670/ProFile/admin" class="nav-link text-dark">ProFile</a></li>
    ...
    <div class=" " style="border:none;display:  flex;">
                      <form action="/asmpd10670/Video/admin/search-trangchu" method="get" class="mx-3">
